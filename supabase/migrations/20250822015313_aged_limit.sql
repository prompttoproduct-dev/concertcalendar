...
('FKA twigs', (SELECT id FROM venues WHERE name = 'Terminal 5' LIMIT 1), '2024-08-15', '21:00', '65', ARRAY['electronic', 'experimental', 'r&b'], 'FKA twigs immersive performance experience', 'https://www.terminal5nyc.com', 'https://images.unsplash.com/photo-1540039155733-5bb30b53aa14?w=800&h=600&fit=crop&q=80', 'ticketmaster'),
